...
function Container(htmlLink, containerName, props, methods, index, pathToContainer, rootLink, isRuncreatedContainer, newProps) {
  ...
  for (var i2 = 0; i2 < props.length; i2++) {
    ...
    if (typeof props[i2] == "string") {
      ...
      this.props[props[i2]] = new Prop(htmlLinkToProp, containerName, props[i2], methods[props[i2]], this.pathToCоmponent, this, this.rootLink, newProps);
    } else {
      ...
      this.props[string] = new Prop(htmlLinkToProp, containerName, props[i2], methods[string], this.pathToCоmponent, this, this.rootLink, newProps);
    }
  }
...
function Prop(htmlLink, keyData1, keyData2, eventMethod, pathToContainer, parentContainer, rootLink, newProps) {
  ...
  if (this.isEvent(this.type) != false && eventMethod != undefined) {
    constructorProp("event", this); //this.events = {	};
    ...
    if (newProps == undefined || newProps[keyData2] == undefined || _typeof(newProps[keyData2]) != "object" || newProps[keyData2].componentName == undefined) {
      ...
      if (objToFind[key5] == "container") {
        if (this.rootLink.description[key5] != undefined && this.rootLink.state[key5] == undefined) {
          ...
          if (nameVirtualArray != null && nameContainer != null) {
            ...
            this.renderChild = container; //console.log(container);
            //console.log("/////////////////");
          }
        }
      }
  ...
  if (StateMap[key]["arrayProps"] != undefined) {
    ...
    for (var t = 0; t < StateMap[key]["arrayProps"].length; t++) {
      if (typeof StateMap[key]["arrayProps"][t] == "string") {
        ...
        this.state[key]["props"][StateMap[key]["arrayProps"][t]] = new Prop(htmlLink, key, StateMap[key]["arrayProps"][t], StateMap[key]["arrayMethods"][StateMap[key]["arrayProps"][t]], key, this.state[key], this);
      } else {
        ...
        this.state[key]["props"][string] = new Prop(htmlLinkToProp, key, StateMap[key]["arrayProps"][t], StateMap[key]["arrayMethods"][string], key, this.state[key], this);
      }
    }
  }
