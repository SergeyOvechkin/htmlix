...
Htmlix это javascrit frontend framework для создания как различных элементов страницы, так и для одностраничных приложений. 
Это универсальный фреймворк подходящий для большинства основных задачъ фронтенд разработки.

Суть его работы заключается в отличном от большинства фреймворков подходе, к построению приложения. 
Вместо того чтобы создавать весь DOM из javascript, здесь реализован обратный подход. 
В уже отданной и построенной сервером странице он ищет все массивы элементов и запоминает к ним ссылки. 
