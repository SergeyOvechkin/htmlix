...
* `.renderByContainer(containerLink=container)` - отображает компонент по ссылке;
* `.setOrCreateAndRender(objWidthProps)` - меняет отображаемый компонента на objWidthProps.componentName если `componentName` - обычный контейнер  устанавливает ему свойства совпавшие с ключами в объекте objWidthProps,
вызвав у него метод setAllProps(objWidthProps), если objWidthProps.componentName - виртуальный массив то удалит старый отображаемый контейнер и создаст новый из виртуального массива, а также установит его свойства,
из ключей объекта objWidthProps вызвав метод массива add(objWidthProps), если objWidthProps.componentName - обычный массив, отображает в свойстве данный массив и вызывает у него метод reuseAll(objWidthProps.data),
...
* **.setProp(newContainer)** - метод определит тип данных и затем вызовет нужный метод из перечисленных выше,
 для текста .render (переключает одиночные контейнеры и массивы),  для контейнера из виртуального массива .renderByContainer, также можно не только изменить отображаемый компонент, но сразу установить ему новые данные для свойств,
 передав объект: для одиночного контейнера и контейнера из виртуального виртуального массива {componentName: "название компонента", prop_name1: "новые данные", prop_name2: "новые данные",............},
 для обычного массива   {componentName: "название компонента", data: [{prop_name1: "новые данные", prop_name2: "новые данные",............}, {prop_name1: "новые данные", prop_name2: "новые данные",............}, ............]},
